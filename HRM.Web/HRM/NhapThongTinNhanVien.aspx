<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NhapThongTinNhanVien.aspx.cs" Inherits="HRM.Web.HRM.NhapThongTinNhanVien" Title="Hồ sơ nhân viên" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <asp:FormView ID="frmMain" runat="server"
        ...
        InsertMethod="frmMain_InsertItem"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlPhongTo" runat="server"
                                    ...
                                    SelectedValue='<%# BindItem.PhongTo.Id %>'>
                                </asp:DropDownList>
                ...
                <div class="col-md-4">
                    <div class="form-group avatar-group">
                        <span style="width: 255px;">
                            <asp:Image ID="ProfilePicture" runat="server" CssClass="avatar-image"/>
                            ...
                            <asp:HiddenField ID="HinhAnh" runat="server" />
                        </span>
                    </div>
                </div>
            </div>            
                        ...
                        <asp:GridView ID="BangCapKhac" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Tên bằng cấp">
                                    <ItemTemplate>
                                        <asp:TextBox ID="TenBangCap" runat="server" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="valTenBangCap" runat="server" ErrorMessage="Chưa chọn tên bằng cấp" ControlToValidate="TenBangCap" CssClass="validation-text" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Cấp độ">
                                    <ItemTemplate>
                                        <asp:TextBox ID="CapDo" runat="server" CssClass="form-control"></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ShowHeader="False" ItemStyle-HorizontalAlign="Right">
                                    <ItemTemplate>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <asp:TextBox ID="NgaySinh" runat="server" CssClass="form-control"></asp:TextBox>
                                            </div>
                                            <div class="col-md-4">
                                                <asp:Label ID="lblNgheNghiep" runat="server" Text="Nghề nghiệp"></asp:Label><br />
                                                <asp:TextBox ID="NgheNghiep" runat="server" CssClass="form-control"></asp:TextBox>
                                            </div>
                                            <div class="col-md-4">
                                                <asp:Label ID="lblTinhTrang" runat="server" Text="Ghi chú"></asp:Label><br />
                                                <asp:TextBox ID="TinhTrang" runat="server" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <asp:Label ID="lblDiaChi" runat="server" Text="Địa chỉ"></asp:Label><br />
                                                <asp:TextBox ID="DiaChi_Xa" runat="server" CssClass="form-control" placeholder="Địa chỉ"></asp:TextBox>
                                            </div>
                                            <div class="col-md-4">
                                                <br />
                                                <asp:TextBox ID="DiaChi_Huyen" runat="server" CssClass="form-control" placeholder="Quận/Huyện/TP"></asp:TextBox>
                                            </div>
                                            <div class="col-md-4">
                                                <br />
                                                <asp:TextBox ID="DiaChi_Tinh" runat="server" CssClass="form-control" placeholder="Tỉnh/Thành"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group text-right">
                        <asp:Button ID="btSubmit" CausesValidation="true" runat="server" Text="Lưu lại" CssClass="btn btn-success btn-lg" CommandName="Insert" />
                    </div>
                </div>
            </div>
        </InsertItemTemplate>
